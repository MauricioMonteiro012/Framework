...
### 1️⃣ Cadastro de Mini Mercado (Vendedor)
...
#### 🔹 Fluxo de Ativação do Vendedor

1. Após o cadastro, um código de 4 dígitos é enviado via **WhatsApp (Twilio)** para o vendedor.
2. O vendedor deverá inserir o código recebido para ativar sua conta.
3. Somente vendedores ativados podem fazer login e gerenciar produtos.

---

### 2️⃣ Autenticação do Vendedor

* O sistema utiliza **JWT** ou **OAuth** para autenticação.
* Vendedores inativos não podem fazer login.

---

### 3️⃣ Gerenciamento de Produtos

Um vendedor autenticado pode:
...
* O vendedor só pode visualizar e gerenciar **seus próprios produtos**.

---

### 4️⃣ Venda de Produtos

O vendedor pode realizar uma venda informando:
...
* Vendedores inativos não podem realizar vendas.
...
"celular": "+559999999999",
"senha": "123456"
}'
```

#### Ativar Vendedor via WhatsApp (Twilio)
